...
class HP:
    ...
    def text_input(self, default: str, *, name: Optional[str] = None) -> str:
        ...
        record = ParameterRecord(name=name, parameter_type="text", default=default, value=result, run_id=self.run_id)
        self.db.add_record(record, run_id=self.run_id)
        return result
    ...
    def multi_text(self, default: List[str] = [], *, name: Optional[str] = None) -> List[str]:
        ...
        record = ParameterRecord(
            name=name, parameter_type="multi_text", default=default, value=result, run_id=self.run_id
        )
        self.db.add_record(record, run_id=self.run_id)
        return result
    ...
    def bool_input(self, default: bool, *, name: Optional[str] = None) -> bool:
        ...
        record = ParameterRecord(name=name, parameter_type="bool", default=default, value=result, run_id=self.run_id)
        self.db.add_record(record, run_id=self.run_id)
        return result
    ...
    def multi_bool(self, default: List[bool] = [], *, name: Optional[str] = None) -> List[bool]:
        ...
        record = ParameterRecord(
            name=name, parameter_type="multi_bool", default=default, value=result, run_id=self.run_id
        )
        self.db.add_record(record, run_id=self.run_id)
        return result
    ...
    def propagate(
        ...
        *,
        ...
        record = NestedDBRecord(name=name, parameter_type="propagate", db=config_func.db, run_id=self.run_id)
        self.db.add_record(record, run_id=self.run_id)
        return result
